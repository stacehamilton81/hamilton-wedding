...
export default function Home() {
 ...
 <div className="border-b border-white/5">
          ...
          <div className="border-b border-white/5">
            ...
            {openSection === 'rsvp' && <div className="pb-6 text-xs leading-relaxed opacity-100">RSVP via your personal email link or contact us directly.</div>}
          </div>
